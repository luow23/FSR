...
class MVTecDataset(Dataset):
    def __init__(self, root_path='D:\BaiduNetdiskDownload\mvtec_anomaly_detection', class_name='bottle', is_train=True, resize=256,
                 trans=None, LOAD_CPU=False):
    ...
    def load_dataset_folder(self):
        ...
        for img_type in img_types:
            ...
            if img_type == 'good':
                ...
                #  os.path.splitext 是将文件中的后缀名和文件名分开   os.path.basename是只要文件名

...
class squeezenet(torch.nn.Module):
    def __init__(self, requires_grad=False, pretrained=True):
        ...
        pretrained_features = tv.squeezenet1_1(pretrained=False)
        pretrained_features.load_state_dict(torch.load(r'squeezenet1_1-f364aa15.pth', map_location='cpu'))

        pretrained_features = pretrained_features.features

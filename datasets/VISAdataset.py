...
class VisADataset(Dataset):
    def __init__(self,
                 dataset_path='D:\IMSN-LW\dataset\VisA',
                 class_name='candle',
                 is_train=True,
                 resize=256,
                 ):
    ...
    def load_dataset_folder(self):
        ...
        for img_type in img_types:
            ...
            img_fpath_list = sorted(
                [os.path.join(img_type_dir, f) for f in os.listdir(img_type_dir) if f.endswith('.png') or f.endswith('.JPG')])
...
class FewshotVisADataset(Dataset):
    def __init__(self,
                 dataset_path='D:\IMSN-LW\dataset\VisA',
                 class_name='candle',
                 is_train=True,
